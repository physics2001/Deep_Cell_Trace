# -*- coding: utf-8 -*-
"""
Created on Wed Nov 16 23:14:00 2022
            ...
            for DROP_OUT in drop_out_list: 
                for MODEL_TYPE in model_type_list: 
                    for NUM_LAYER in num_layer_list: 
                        folder = "Classification_On_Encoded_Reprogramming_Data/{4}_Encoded_Genes_Two_Classes_Without_12_15_21_28/Features_{0}_Dropout_{1}_NumLayer_{2}_ModelType_{3}/".format(FEATURES, DROP_OUT, NUM_LAYER, MODEL_TYPE, n_top_genes)
                        filepath = "model"
                        os.makedirs(folder)
...
RESULT_DF.to_csv("Classification_Reprogramming_Two_Classes_{0}_Genes_Result_Without_12_15_21_28.csv".format(n_top_genes))
