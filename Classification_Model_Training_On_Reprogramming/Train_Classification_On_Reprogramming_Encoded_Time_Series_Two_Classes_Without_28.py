# -*- coding: utf-8 -*-
"""
Created on Wed Nov 16 00:38:28 2022
            ...
            for DROP_OUT in drop_out_list: 
                for MODEL_TYPE in model_type_list: 
                    for NUM_LAYER in num_layer_list: 
                        ...
                        es = EarlyStopping(monitor='val_accuracy', patience=100, min_delta=5e-6)
...
RESULT_DF.to_csv("Classification_Reprogramming_Two_Classes_{0}_Genes_Result_Without_28.csv".format(n_top_genes))
