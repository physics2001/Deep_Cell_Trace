# -*- coding: utf-8 -*-
"""
Created on Thu Jan 12 01:21:36 2023
    ...
    for DROP_OUT in drop_out_list: 
        for MODEL_TYPE in model_type_list: 
            for NUM_LAYER in num_layer_list: 
                folder = "Classification_On_Encoded_Data_Mon_Neu_Two_Classes_Without_Day6_11/Features_{0}_Dropout_{1}_NumLayer_{2}_ModelType_{3}/".format(FEATURES, DROP_OUT, NUM_LAYER, MODEL_TYPE)
                filepath = "model"
                os.makedirs(folder)
                ...
                RESULT_DF.to_csv("Classification_Mon_Neu_Result_Two_Classes_Without_Day6_11.csv")
