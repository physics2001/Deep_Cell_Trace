# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 18:55:57 2022
    ...
    for DROP_OUT in drop_out_list: 
        for MODEL_TYPE in model_type_list: 
            for NUM_LAYER in num_layer_list: 
                ...
                spcorr_test.to_csv(reg_folder+"spearman_correlation_test_data.csv")
                pcorr_test.to_csv(reg_folder+"pearson_correlation_test_data.csv")
...
RESULT_DF.to_csv("Regression_On_Not_Encoded_Data_Neu_Mon_Two_Classes_Day6.csv")
