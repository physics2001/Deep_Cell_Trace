# -*- coding: utf-8 -*-
"""
Created on Tue Nov 22 14:54:25 2022
...
RESULT_DF.to_csv("Perturb_Reprogramming_{0}_Genes_Not_Encoded_Day_21_28_Gened_Change_In_Reprog_Result_With_Init_Class_Info.csv".format(n_top_genes), index=False)
